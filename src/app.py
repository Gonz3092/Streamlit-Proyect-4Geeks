...
nivel_glucosa = st.number_input('Nivel de insulina en sangre', min_value=0.0, step=0.1, format="%.1f")
...
if st.button('Predecir'):
    # Preparar datos
    features = np.array([[n_embarazos, nivel_glucosa, presion_sangre, nivel_insulina, bmi,dpf, edad]])
